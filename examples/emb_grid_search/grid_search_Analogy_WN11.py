...
train_test.grid_search([
    {
        ...
        'regul_weight'               : [0.01,0.001], # the regularization weight in the loss function
    ...
    },
    {
        ...
        # 'score_norm'                 : 'l2', # for TransX models
        # 'embedding_initialization'   : 'TransE/1524490825', # initialize parameters from another model
        'regul_weight'               : [0.01], # the regularization weight in the loss function
    ...
    },
    {
        ...
        ### negative examples and training settings
        'ent_neg_rate'               : 2, # (defaults to 1)
        'rel_neg_rate'               : 1, # (defaults to 0)
